...
namespace inercya.EntityLite.SqliteProfiler.Entities
{
	...
	public partial class StatementRepository : Repository<Statement> 
	{
		...
		public new SqliteLoggerDataService  DataService  
		{
			get { return (SqliteLoggerDataService) base.DataService; }
...
namespace inercya.EntityLite.SqliteProfiler.Entities
{
	public partial class SqliteLoggerDataService : DataService
	{
        ...
        public SqliteLoggerDataService() : base("AppConnectionString")
        {
			Init();
        }

        public SqliteLoggerDataService(string connectionStringName) : base(connectionStringName)
        {
			Init();
        }

        public SqliteLoggerDataService(string connectionString, string providerName) : base(connectionString, providerName)
        {
			Init();
        }
