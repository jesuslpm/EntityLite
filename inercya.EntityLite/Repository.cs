...
namespace inercya.EntityLite
{
    ...
    public class Repository<TEntity> : IRepository<TEntity> where TEntity: class, new()
    {
        ...
        public virtual void Save(TEntity entity)
        {
            ...
            if (metadata == null)
            {
                throw new ArgumentException(string.Format("{0} is not an entity, it hasn't been decorated with SqlEntity attribute", entityType.Name));
            }
            ...
            {
                throw new ArgumentException(string.Format("{0} cannot be saved, because its primary key is multiple, use insert and update instead", entityType.Name));
            }
